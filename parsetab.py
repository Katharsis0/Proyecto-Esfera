...
_lr_productions = [
  ...
  ('oper -> factor','oper',1,'p_oper','myparser.py',406),
  ('oper -> expression','oper',1,'p_oper','myparser.py',407),
  ('oper -> ID','oper',1,'p_oper','myparser.py',408),
  ('change -> ID LP value RP SEMICOLON','change',5,'p_change','myparser.py',415),
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','myparser.py',429),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','myparser.py',433),
  ('expression -> term','expression',1,'p_expression_term','myparser.py',437),
  ('term -> term STAR factor','term',3,'p_term_times','myparser.py',445),
  ('term -> term SLASH factor','term',3,'p_term_div','myparser.py',449),
  ('term -> factor','term',1,'p_term_factor','myparser.py',453),
  ('factor -> INTEGER','factor',1,'p_factor_num','myparser.py',457),
  ('factor -> MINUS expression','factor',2,'p_factor_uminus','myparser.py',463),
  ('factor -> LP expression RP','factor',3,'p_factor_expr','myparser.py',467),
  ('comment -> COMMENT','comment',1,'p_comment','myparser.py',474),
]
